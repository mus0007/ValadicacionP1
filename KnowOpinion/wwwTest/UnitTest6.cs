...
{
    [TestClass]
    public class ModificarEncuesta
    {
        ...
        [TestMethod]
        public void TheModificarEncuestaTest()
        {
            ...
            driver.FindElement(By.Id("btnmodificar")).Click();
            driver.FindElement(By.Id("btnModificar")).Click();
            ...
            driver.FindElement(By.Id("btnModificar")).Click();
            driver.FindElement(By.Id("btnSeleccionar")).Click();
            driver.FindElement(By.Id("txtModificarDescripcion")).Clear();
            driver.FindElement(By.Id("txtModificarDescripcion")).SendKeys("aaaa");
            driver.FindElement(By.Id("btnModificar")).Click();
            driver.FindElement(By.Id("txtEncuestaSeleccionada")).Clear();
            driver.FindElement(By.Id("txtEncuestaSeleccionada")).SendKeys("Encuesta1");
            driver.FindElement(By.Id("btnSeleccionar")).Click();
            driver.FindElement(By.Id("txtModificarDescripcion")).Clear();
            driver.FindElement(By.Id("txtModificarDescripcion")).SendKeys("NuevaDescripcionEncuesta1");
            driver.FindElement(By.Id("btnModificar")).Click();
        }
